    ...
    return (
        <section style={{marginTop:'100px'}}className="header text-center">
            ...
            <div>
                ...
                <a className="btn btn-success ms-2" target="_blank" href='https://drive.google.com/uc?export=download&id=1fUZB10EefdDndrcj3yM0eNoXxHyUlzx6'><FontAwesomeIcon icon={faFileDownload} /> Download Resume</a>
            </div>
